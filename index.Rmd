...
lm_fit <- train(length ~ ., data=training, method='lm', metric='rsquared', trControl=ctrl, preProc=c('center', 'scale'), tuneGrid = grid)
lm_fit
```
...
ridge_fit <- train(length ~ ., data=training, method='ridge', metric='rsquared', trControl=ctrl, preProc=c('center', 'scale'), tuneGrid = grid)
ridge_fit
```
...
lasso_fit <- train(length ~ ., data=training, method='lasso', metric='rsquared', trControl=ctrl, preProc=c('center', 'scale'), tuneGrid = grid)
lasso_fit
```
...
rf_fit <- train (length ~ ., data = training, method='rf', metric='rsquared', preProc=c('center', 'scale'), trControl=ctrl, tuneGrid = grid, ntree=15)
rf_fit
```
