...
Wszystkie modele w różnym stopniu zwróciły uwagę na istotność istnienia poszczególny rodzajów glonów, w szczególności na rodzaj `cfin1`, który może być konsumowany przez poszczególne gatunki śledzia. Wraz ze wzrostem pożywienia, rośnie potencjalna wielkość osobników danego gatunku.
